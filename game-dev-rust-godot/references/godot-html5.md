...
```
Godot 버전: 4.6 stable
위치: /home/spritz/godot4
프로젝트 디렉토리: /home/spritz/godot4/projects/
```
...
```bash
cd /home/spritz/godot4/projects
mkdir <game-name>
cd <game-name>
...
```bash
cd /home/spritz/godot4/projects/<game-name>
...
scp -r build/web/* kjaylee@100.91.184.81:/Users/kjaylee/.openclaw/workspace/eastsea-blog/games/<game-name>/
...
# Editor → Debug → Deploy Remote Debug → tcp://100.80.169.94:6007
```
