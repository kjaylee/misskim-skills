...
- **Remotion 프로젝트:** `/home/spritz/remotion-videos`
- **FFmpeg:** 전역 설치됨
...
await nodes.run({
  node: "MiniPC",
  command: "cd /home/spritz/remotion-videos && npx remotion render MyComp out/result.mp4"
});
```

## ⚠️ 주의사항

1. **MiniPC 경로:** 항상 `/home/spritz/` 기준 절대 경로를 확인하세요.
